<div>
    <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
        ...
        <a href="{{ route('admin.pages.form') }}" class="btn-primary flex items-center justify-center gap-2 whitespace-nowrap" wire:navigate>
                        ...
                        <tr class="hover:bg-white/5 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-3">
                                    ...
                                    <a href="{{ route('admin.pages.form', $page->id) }}" class="text-[#FFC800] hover:text-[#D4A000] transition-colors" wire:navigate title="Edit Page">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
