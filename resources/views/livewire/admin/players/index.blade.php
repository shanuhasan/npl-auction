<div>
    ...
    <div class="bg-card-bg p-4 rounded-lg shadow mb-6 border border-gray-800 flex space-x-4">
        <input type="text" wire:model.live="search" placeholder="Search by name..." class="flex-1 bg-primary-bg border border-gray-700 rounded py-2 px-3 text-white focus:outline-none focus:border-accent-gold">
        ...
        <select wire:model.live="filterStatus" class="bg-primary-bg border border-gray-700 rounded py-2 px-3 text-white focus:outline-none focus:border-accent-gold">
