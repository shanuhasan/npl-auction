<div>
    <div class="mb-6 flex justify-between items-center">
        <h1 class="text-3xl font-poppins font-bold text-white">Edit Auction Setup</h1>
    ...
    <form wire:submit.prevent="save" class="space-y-8">
        ...
        <div class="bg-card-bg rounded-lg shadow p-6 border border-gray-800">
            ...
            <p class="text-gray-400 text-sm mb-4 border-b border-gray-700 pb-2">Selected players will be automatically ordered for the auction (Marquee first, then Set A, Set B, etc., sorted by Base Price). Already selected players can be deselected (if they haven't been sold yet).</p>
            ...
            @empty
                <p class="text-gray-400">No available players found.</p>
            @endforelse
        </div>

        <div class="flex justify-end pt-4 pb-10">
            <button type="submit" class="bg-accent-gold text-primary-bg px-8 py-3 rounded-lg font-bold text-lg hover:bg-yellow-400 transition shadow-lg w-full md:w-auto">Update Auction</button>
        </div>
    </form>
</div>
